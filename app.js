...
var $author$project$PitchIntervalQuizzer$sineWave = _Platform_outgoingPort(
	'sineWave',
	function ($) {
		var a = $.a;
		var b = $.b;
...
var $author$project$PitchIntervalQuizzer$SetUserGuess = function (a) {
	return {$: 'SetUserGuess', a: a};
};
...
var $author$project$PitchIntervalQuizzer$renderAnswers = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick($author$project$PitchIntervalQuizzer$RequestNewInterval)
					]),
				_List_fromArray(
					[
...
var $author$project$PitchIntervalQuizzer$main = $elm$browser$Browser$element(
	{
		init: $author$project$PitchIntervalQuizzer$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$PitchIntervalQuizzer$update,
		view: $author$project$PitchIntervalQuizzer$view
	});
_Platform_export({'PitchIntervalQuizzer':{'init':$author$project$PitchIntervalQuizzer$main(
